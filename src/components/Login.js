...
const LoginModal = ({ closeModal, setIsRegisterModalOpen, closeRegisterModal }) => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch('https://zany-gold-sheep-robe.cyclic.app/users/login', {
                method: 'POST',
                headers: {
            ...
            >
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div>
                            <p>Not have an account! <span onClick={() => { closeModal(); setIsRegisterModalOpen(true); }} className='text-blue-300 text-sm cursor-pointer'>Sign-Up Now</span></p>
                        </div>
                    </div>
                </form>
            </motion.div>
